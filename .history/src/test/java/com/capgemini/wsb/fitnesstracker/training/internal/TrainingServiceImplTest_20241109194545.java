...
class TrainingServiceImplTest {
    ...
    @Test
    void createTraining_throwsUnsupportedOperationException() {
        Training training = new Training();

        assertThrows(UnsupportedOperationException.class, () -> trainingServiceImpl.createTraining(training));
    }

    @Test
    void updateTraining_throwsUnsupportedOperationException() {
        Training training = new Training();

        assertThrows(UnsupportedOperationException.class, () -> trainingServiceImpl.updateTraining(training));
    }
}