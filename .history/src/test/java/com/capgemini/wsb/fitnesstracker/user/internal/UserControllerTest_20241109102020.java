...
import com.capgemini.wsb.fitnesstracker.IntegrationTestBase.existingUser;
...
import static com.capgemini.wsb.fitnesstracker.user.internal.UserApiIntegrationTest.generateUser;
...
class UserControllerTest {
    ...
    void getAllUsers_returnsListOfUserDtos() {
        List<User> users = List.of(new User(existingUser(generateUser())), new User(generateUser()));
